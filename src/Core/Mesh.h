...
class Mesh
{
  ...
  struct Shader {
    static constexpr char* vertexShaderPath = "shaders/SimpleVertexShader.vertexshader";
    static constexpr char* fragmentShaderPath = "shaders/SimpleFragmentShader.fragmentshader";
